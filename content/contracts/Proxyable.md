...
**Source:** [Proxyable.sol](https://github.com/Synthetixio/oikos/blob/master/contracts/Proxyable.sol)
...
In the case of the [`Oikos`](Oikos.md) contract, this integrationProxy is an instance of the [ERC20 proxy](ProxyERC20.md).
