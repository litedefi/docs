...
In the Oikos system, an ERC20 proxy operates in front of the main [OKS token contract](Oikos.md), alongside the pre-existing standard proxy. Thus clients can choose to use either of these two proxies to interact with the system.

**Source:** [ProxyERC20.sol](https://github.com/Synthetixio/oikos/blob/master/contracts/ProxyERC20.sol)
