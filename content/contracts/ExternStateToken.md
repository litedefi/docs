...
The main [`Oikos`](Oikos.md) contract and all [`Synths`](Synth.md) are ExternStateTokens.

**Source:** [ExternStateToken.sol](https://github.com/Synthetixio/oikos/blob/master/contracts/ExternStateToken.sol)
