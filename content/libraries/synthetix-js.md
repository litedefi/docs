!!! info "Notice"
		Imported from https://github.com/Synthetixio/oikos-js

# SynthetixJs library

[![CircleCI](https://circleci.com/gh/Synthetixio/oikos-js.svg?style=svg)](https://circleci.com/gh/Synthetixio/oikos-js) [![npm version](https://badge.fury.io/js/oikos-js.svg)](https://badge.fury.io/js/oikos-js)
...
The Oikos-JS Library provides a simple pre-packaged API to communicate with [Oikos](https://oikos.cash) on ethereum. You can use it to contribute to DeFi's growing synthetic asset ecosystem.
...
```javascript
const { SynthetixJs } = require('oikos-js');
...
const snxjs = new SynthetixJs({ signer: metaMaskSigner }); //uses Metamask signer 
```
